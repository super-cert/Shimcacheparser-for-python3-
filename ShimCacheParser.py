...
def read_cache(cachebin, quiet=False):
    ...
    try:
        ...
        wefwfwef
        print( "[-] 1 Error reading Shim Cache data: %s" % err)
        return None
...
def read_nt5_entries(bin_data, entry):
    ...
    try:
        ...
        print( "[-] 2 Error reading Shim Cache data: %s..." % err)
        return None
...
def read_nt6_entries(bin_data, entry):
    ...
    try:
        ...
        print( '[-] 3 Error reading Shim Cache data: %s...' % err)
        return None
...
def read_winxp_entries(bin_data):
    ...
    try:
        ...
        print( "[-] 4 Error reading Shim Cache data %s" % err)
        return None
